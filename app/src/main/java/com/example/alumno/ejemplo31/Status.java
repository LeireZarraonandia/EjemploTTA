...
public class Status implements Serializable {
    ...
    public Status(int id, String user, int lesson, String lesson_title, int nexTest, int nextExercise,String user_dni,String user_pss) {
        this.id = id;
        this.user = user;
        this.lesson = lesson;
